...
<body class="antialiased">
    ...
    <table class="border p-1 rounded-md w-96">
        <thead >
        ...
        <tbody id="list_todo">
            ...
            <tr>
                ...
                <td>{{$data->name}}</td>
                <td>
                    <button type="button" id="edit_todo">Edit</button>
                    <button type="button" id="delete_todo">Delete</button>
                </td>
            </tr>
            @endforeach
        </tbody>
    ...
    <!-- <div
        ...
        <div class="sm:fixed sm:top-0 sm:left-0 p-6 text-right z-10">
            ...
            <a href="{{ url('/manager/dashboard') }}"
                class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Manager
                Dashboard</a>
            @else
            ...
            <a href="{{ route('manager.register') }}"
                class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Manager
                Register</a>
            @endif
            @endauth
        </div>
