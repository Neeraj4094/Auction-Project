    ...
    <div class="w-full">
        <div class="flex items-center justify-between  p-2 py-4 border-b w-full h-full px-3">
            ...
            <div class="grid space-y-3">
                ...
                <form action="{{url('/admin/category')}}" method="get" class="relative">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{url('/admin/category/add')}}" class="px-5 py-2 rounded-md text-white bg-blue-600">
                    <span class="">Add category</span>
                </a>
                <a href="{{url('/admin/category/trash_data')}}" class="px-5 py-2 rounded-md text-white bg-blue-600">
                    <span class="">Category Trash Data</span>
                </a>
            </div>
        </div>
        ...
        <div class="border p-3 overflow-y-scroll h-[360px]">
                ...
                <div class="border rounded-lg grid grid-cols-2 p-2">
                    ...
                    <div class="flex items-center justify-between gap-2">
                        ...
                        <form action="{{url('/admin/category/edit',['id'=>$user->id])}}" method="get">
                        @csrf
                            <button type="submit">Edit</button>
                        </form>
                        <form action="{{url("/admin/category/delete/$user->id")}}" method="post">
                        @csrf
                            <button type="submit">Delete</button>
                        </form>
